...
// 本模块Session CONNECT的golden字节（150字节）：
// 会话层SPDU(1) + 长度(1) + 连接项20字节 + c1用户数据(表示层CP 126字节)。
// 连接项与实测装置接受的报文一致：05 06 13 01 00 16 01 02 14 02 00 02 33 02 00 01 34 02 00 01。
constexpr std::array<std::uint8_t, 150> kExpectedSessionConnect{
    };
