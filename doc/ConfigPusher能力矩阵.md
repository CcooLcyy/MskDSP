...
- 进入配置下发阶段后，IEC61850完整目标态在DataCenter路由之前下发；其余配置继续按 `IEC104 -> ModbusRTU -> DLT645 -> AGC -> AVC -> Calc -> DataCenter` 的顺序串行执行。
