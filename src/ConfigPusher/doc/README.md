...
- IEC104 从站收到有效对时命令后直接设置系统时间，运行容器需具备 `CAP_SYS_TIME`
    ...
    "links": [
      {
        ...
        "point_table": {
          ...
          "points": [
            ...
            { "tag": "breaker", "ioa": 24577, "type": "POINT_TYPE_SINGLE", "business_type": "POINT_BUSINESS_TYPE_REMOTE_CONTROL", "remote_control_type": "REMOTE_CONTROL_TYPE_DOUBLE", "command_execution_mode": "COMMAND_EXECUTION_MODE_SELECT_EXECUTE" }
          ]
        },
        "start": true
      }
